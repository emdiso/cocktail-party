...
exports.updateCustomRecipe = exports.insertCustomRecipe = void 0;
const dotenv_1 = __importDefault(require("dotenv"));
const psqlConnection_1 = __importDefault(require("./psqlConnection"));
dotenv_1.default.config();
const insertCustomRecipe = (user_id, recipe) => {
    return psqlConnection_1.default.query(`INSERT INTO custom_recipes
...
exports.insertCustomRecipe = insertCustomRecipe;
const updateCustomRecipe = (user_id, recipe) => {
    return psqlConnection_1.default.query(`UPDATE custome_recipes
        ...
        "strMeasure14"=$34, "strMeasure15"=$35, "dateModified"
...
exports.updateCustomRecipe = updateCustomRecipe;
